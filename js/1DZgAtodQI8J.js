        ...
        g = (function (e) {
          function t(t, n) {
            ...
            return (
              ...
              t.in
                ? a
                  ? ((r = m), (o.appearStatus = v))
                  : (r = y)
                : (r = t.unmountOnExit || t.mountOnEnter ? d : m),
              (o.state = { status: r }),
              (o.nextCallback = null),
              o
            );
          ...
          p = function (e, t) {
            ...
            return (
              ...
              n.useEffect(
                function () {
                  if (D.current) {
                    if (!d) return void D.current.resetSegments(!0);
                    Array.isArray(d) &&
                      d.length &&
